...
def main():
    students = load_students(r'C:\Users\MSI\Downloads\FindFriendPY-main2\FindFriendPY-main\data\student_info.txt')
    load_hobbies(r'C:\Users\MSI\Downloads\FindFriendPY-main2\FindFriendPY-main\data\hobbyc.txt', students)
    load_habits(r'C:\Users\MSI\Downloads\FindFriendPY-main2\FindFriendPY-main\data\habitc.txt', students)

    graph = Graph()
    load_edges(r'C:\Users\MSI\Downloads\FindFriendPY-main2\FindFriendPY-main\data\friends.txt', graph)
